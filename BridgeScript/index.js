...
(function (exports) {
    ...
    proto.addListener = function addListener(evt, listener) {
        ...
        ENDO.addListenerWithNameOwner(evt, this);
        return this;
    };
    /**
...
var _EDO_MetaClass = /** @class */ (function () {
    ...
    return _EDO_MetaClass;
}());
var _EDO_Callback = /** @class */ (function () {
    function _EDO_Callback(func) {
        this.func = func;
        this._meta_class = { classname: "__Function" };
    }
    return _EDO_Callback;
}());
var EDOObject = /** @class */ (function (_super) {
    __extends(EDOObject, _super);
    function EDOObject() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.__callbacks = [];
        return _this;
    }
    EDOObject.prototype.__convertToJSValue = function (parameter) {
        if (typeof parameter === "function") {
            var callback = new _EDO_Callback(parameter);
