...
// UTCPTUSBDeviceDidAttachNotification
// Posted when a device has been attached. Also posted for each device that is
// already attached when the UTCPTUSBHub starts listening.
//
//  .userInfo = {
//    DeviceID = 3;
...
//  }
//
FOUNDATION_EXPORT NSString * const UTCPTUSBDeviceDidAttachNotification;

// UTCPTUSBDeviceDidDetachNotification
...
//  }
//
FOUNDATION_EXPORT NSString * const UTCPTUSBDeviceDidDetachNotification;

// NSError domain
FOUNDATION_EXPORT NSString * const UTCPTUSBHubErrorDomain;

// Error codes returned with NSError.code for NSError domain UTCPTUSBHubErrorDomain
typedef enum {
  UTCPTUSBHubErrorBadDevice = 2,
  UTCPTUSBHubErrorConnectionRefused = 3,
} UTCPTUSBHubError;

@interface UTCPTUSBHub : NSObject
