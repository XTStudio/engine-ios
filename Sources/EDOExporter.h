...
#define EDO_EXPORT_PROPERTY(A) [[EDOExporter sharedExporter] exportProperty:[self class] propName:A enumerable:NO];
#define EDO_EXPORT_ENUMERABLE_PROPERTY(A) [[EDOExporter sharedExporter] exportProperty:[self class] propName:A enumerable:YES];
...
- (void)exportProperty:(Class)clazz propName:(nonnull NSString *)propName enumerable:(BOOL)enumerable;
